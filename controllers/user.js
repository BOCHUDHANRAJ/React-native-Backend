...
import { cookieOptions,getDataUri,sendToken, sendEmail } from "../utils/features.js";
...
export const login = asyncError(async(req,res,next)=>{ 
        ...
        //Handle error
        //the password which you used it should be same as above
...
export const signup = asyncError(async (req, res, next) => {
  ...
  export const updateProfile = asyncError(async(req,res,next)=>{  
    ...
    if (pinCode) user.country = pinCode;
   ...
   export const updatePic =  asyncError(async (req, res, next) => {
    ...
    await cloudinary.v2.uploader.destroy(user.avatar.public_id);//deleting image
  ...
  export const forgetpassword = asyncError(async (req, res, next) => {
    ...
    const otp_expire = 15 * 60 * 1000;//15 mins
